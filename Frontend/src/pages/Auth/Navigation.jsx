...
import FavoriteCount from '../Products/FavoriteCount.jsx';
  ...
  return (
    ...
    flex-col justify-between p-4 text-white bg-black w-[4%] hover:w-[15%] h-[100vh] fixed`}  id="navigation-container">
      ...
      <div className="flex flex-col justify-center space-y-4">
        <Link to="/" className="flex items-center transition-transform transform hover:translate-x-4">
          <AiOutlineHome className='mr-2 mt-[3rem]' size={26}/>
          <span className=" hidden nav-item-name mt-[3rem]">HOME</span>
        </Link>

        <Link to="/shop" className="flex items-center transition-transform transform hover:translate-x-4 ">
      ...
      <div className="relative">
        ...
        <button className="flex items-center py-2 text-white bg-black hover:bg-gray-8000 focus:outline-none" onClick={toggleDropdown}>
