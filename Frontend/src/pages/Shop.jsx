...
const Shop = () => {
    ...
    const categoryQuery = useFetchCategoriesQuery();
    ...
    }, [checked, radio ,filterProductsQuery.data, priceFilter, dispatch]);
    ...
    //Add all brands to unique brands array
    const uniqueBrands =[
        ...Array.from(
            new Set(filterProductsQuery.data?.map(product => product.brand).filter((brand) => brand !== undefined))
        )
    ]
        ...
        <>
            <div className="container mx-auto">
                ...
                <div className="bg-[#151515] p-3 mt-2 mb-2">
                    ...
                    <button
                        className="w-full border border-white text-white my-4"
